...
class CompiledApp {
  ...
  async instantiate(additionalImports, {loadDeferredWasm} = {}) {
    ...
    const dart2wasm = {
      ...
      _1627: (x0,x1,x2,x3) => x0.addEventListener(x1,x2,x3),
      ...
      _1715: x0 => new FinalizationRegistry(x0),
      _1716: (x0,x1,x2,x3) => x0.register(x1,x2,x3),
      _1719: Date.now,
      ...
      _1736: () => globalThis.FinalizationRegistry,
      ...
      _2650: (x0,x1) => x0.srcdoc = x1,
      _2655: (x0,x1) => x0.allow = x1,
      _2667: x0 => x0.contentWindow,
